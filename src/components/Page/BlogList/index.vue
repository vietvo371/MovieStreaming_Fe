          ...
          <div class="trending__product">
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12">
                <ul
                  class="nav nav-tabs section-title"
                  style="
                    ...
                    <template v-if="k == 0">
                      <li class="nav-item" role="presentation">
                        <button
                          ...
                          id="home-tab"
                          data-bs-toggle="tab"
                          v-bind:data-bs-target="'#home-tab-pane' + k"
                          type="button"
                          role="tab"
                          aria-selected="true"
                        >
                    ...
                    <template v-else>
                      <li class="nav-item" role="presentation">
                        <button
                          ...
                          id="profile-tab"
                          data-bs-toggle="tab"
                          v-bind:data-bs-target="'#profile-tab-pane' + k"
                          type="button"
                          role="tab"
                          aria-selected="false"
                        >
                            ...
                            <router-link :to="`/blog/${v1.slug_tieu_de}`">
                              ...
                              >
                                ...
                                >
                                  ...
                                  <h4>
                                    <router-link
                                      :to="`/blog/${v1.slug_tieu_de}`"
                                    >
                                      <a
                                        v-bind:href="'/blog' + v1.slug_tieu_de"
                                      >
                                        {{ v1.tieu_de }}</a
                                      ></router-link
                                    >
