        ...
        <div class="row">
          <div class="col-lg-8">
                  ...
                  <div v-if="k < 3"  class="col-lg-4 col-md-6 col-sm-6">
                    <div class="product__item">
                      ...
                      <div class="product__item__pic" v-bind:style="{
                        ...
                        <div v-if="v.ten_loai_phim == 3" class="ep">18 / 18</div>
                        <div class="comment">
                        </div>
            ...
            <template v-for="(v1,k1) in list_the_loai">
              ...
              <div class="row">
                <template v-for="(v, k) in list_phim">
                  <template v-if="v.id_the_loai == v1.id , k < 6" >
                    <div class="col-lg-4 col-md-6 col-sm-6">
                      <div  class="product__item">
                        <img src="" alt="" />
                        <div class="product__item__pic" v-bind:style="{
                            'background-image': 'url(' + v.hinh_anh + ')',}">
                          <div v-if="v.id_the_loai == 3" class="ep">18 / 18</div>
                          <div class="comment">
                          </div>
                          <div class="view"><i class="fa fa-eye"></i> 9141</div>
                        </div>
              ...
              <div class="product__sidebar__view">
                ...
                <div class="filter__gallery" id="MixItUpF5B6EA">
                  <template v-for="(v,k) in Show1object">
                    ...
                    v-bind:style="{'background-image': 'url(https://themewagon.github.io/anime/img/sidebar/tv-4.jpg )',}">
                    <div class="ep">18 / ?</div>
                    <div class="view"><i class="fa fa-eye"></i> 9141</div>
                    <h5>
                      <a href="#">{{  v.ten_phim }}</a>
