        ...
        <div class="card border-5 border-primary border-top">
          ...
          <div class="card-body">
            ...
            <div class="mb-3 mt-1">
              ...
              <input v-model="obj_add_phim.mo_ta" type="text" class="form-control" placeholder="nhập slug phim..." />
            </div>
            <div class="mb-3 mt-1">
              <label for="" class="form-label mb-1 mt-1">
                <b>Url Youtube</b>
            ...
            <div class="mb-3">
              ...
              <select v-model="obj_add_phim.tinh_trang" name="" id="" class="form-control">
          ...
          <div class="card-footer text-end">
            <button @click="taoDataPhim()" class="btn btn-primary">Thêm Mới</button>
          </div>
        </div>
      </div>
      <div class="col-8">
            ...
            <table class="table table-bordered">
              <thead>
                ...
                <tr class="text-center">
                  ...
                  <th class="text-center align-middle text-nowrap">Url Youtube</th>
              ...
              <tbody>
                <tr v-for="(v, k) in list_phim" class="text-center">
                  ...
                  <td class="text-center align-middle text-nowrap">
                    <button @click="Object.assign(obj_update_phim,v)" type="button" class="btn btn-warning me-1" data-bs-toggle="modal"
                      data-bs-target="#Chinhsua">
                      Chỉnh Sữa
                    </button>

                    <button @click="Object.assign(obj_delete_phim,v)" data-bs-target="#Xoa" data-bs-toggle="modal" class="btn btn-danger">
                      Xoá
                    </button>
                  </td>
                </tr>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body text-start">
                    <div class="mb-3 mt-1">
                      ...
                      <input v-model="obj_update_phim.ten_phim" type="text" class="form-control"
                    ...
                    <div class="mb-3 mt-1">
                      ...
                      <input v-model="obj_update_phim.url" type="text" class="form-control"
                    ...
                    <div class="mb-3">
                      ...
                      <select v-model="obj_update_phim.tinh_trang"  class="form-control">
                        <option value="0">Tạm Dừng</option>
                        <option value="1">Hoạt động</option>
                      </select>
                    </div>
                  ...
                  <div class="modal-footer">
                    ...
                    <button @click="updatePhim()" type="button" class="btn btn-success" data-bs-dismiss="modal">Lưu</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <button @click="deletePhim()" type="button" class="btn btn-danger" data-bs-dismiss="modal">Vẫn Xoá</button>
                  </div>
                </div>
              </div>
            </div>
  ...
  export default {
    data() {
      return {
        ...
        list_the_loai    : [],
        list_phim: [],
        obj_add_phim: { 'tinh_trang_yeu_thich': 0, },
        key_tim: {},
        obj_update_phim: {},
        obj_delete_phim: {},
      };
    ...
    methods: {
      ...
      taoDataPhim() {
        axios
          .post(
            "http://127.0.0.1:8000/api/admin/phim/thong-tin-tao",
            this.obj_add_phim
          )
          .then((res) => {
      ...
      searchPhim() {
        axios
          .post('http://127.0.0.1:8000/api/admin/phim/thong-tin-tim', this.key_tim)
          .then((res) => {
            this.list_phim = res.data.phim;
          });
      },
      deletePhim() {
        axios
          .delete('http://127.0.0.1:8000/api/admin/phim/thong-tin-xoa/' + this.obj_delete_phim.id)
          .then((res) => {
            if (res.data.status == true) {
      ...
      updatePhim() {
        axios
          .put('http://127.0.0.1:8000/api/admin/phim/thong-tin-cap-nhat', this.obj_update_phim)
          .then((res) => {
            if (res.data.status == true) {
              toaster.success('Thông báo<br>' + res.data.message);
              this.laydataPhim();
      ...
      doiTrangThai(xyz) {
        axios
          .put('http://127.0.0.1:8000/api/admin/phim/thong-tin-thay-doi-trang-thai', xyz)
          .then((res) => {
            if (res.data.status == true) {
              toaster.success('Thông báo<br>' + res.data.message);
              this.laydataPhim();
