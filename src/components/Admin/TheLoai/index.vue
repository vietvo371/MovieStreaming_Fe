      ...
      <div class="col-3">
        <div class="card border-5 border-primary border-top">
          ...
          <div class="card-footer text-end">
            <button @click="taoDataTheLoai()" class="btn btn-primary">Thêm Mới</button>
          </div>
        </div>
      </div>
      <div class="col-8">
            ...
            <table class="table table-bordered">
              <thead>
                <tr>
                     <th colspan="100%">
                            <div class="input-group mb-3">
                                <input v-on:keyup.enter="searchTheLoai()" v-model="key_tim.key"  type="text"
                ...
                <tr class="text-center">
                  ...
                  <th class="text-center align-middle text-nowrap">Tên Thể Loại</th>
                  <th class="text-center align-middle text-nowrap">Slug Thể Loại</th>
              ...
              <tbody>
                ...
                <tr v-for="(v, k) in list_the_loai" class="text-center">
                  ...
                  <td class="text-center align-middle text-nowrap">
                    <button @click="Object.assign(obj_update_the_loai,v)" type="button" class="btn btn-success me-1" data-bs-toggle="modal" data-bs-target="#Chinhsua">
                      Chỉnh Sữa
                    </button>

                    <button @click="Object.assign(obj_delete_the_loai,v)" data-bs-target="#Xoa" data-bs-toggle="modal" class="btn btn-danger">
                      Xoá
                    </button>
                  </td>
                </tr>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body ">
                    ...
                    <div class="mb-3">
                      ...
                      <select  v-model="obj_update_the_loai.tinh_trang" name="" id="" class="form-control">
                        <option value="0">Tạm Dừng</option>
                        <option value="1">Hoạt động</option>
                      </select>
                    </div>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body text-start">
                    <div class="alert alert-danger" role="alert">
                      Bạn muốn xoá thể loại phim <b>{{ obj_delete_the_loai.ten_the_loai }}</b> !!!
                    </div>
                  </div>
                  <div class="modal-footer">
